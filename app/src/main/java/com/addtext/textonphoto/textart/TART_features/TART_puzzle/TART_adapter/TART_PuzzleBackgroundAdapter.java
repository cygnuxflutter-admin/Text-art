...
public class TART_PuzzleBackgroundAdapter extends RecyclerView.Adapter<TART_PuzzleBackgroundAdapter.ViewHolder> {
    ...
    public TART_PuzzleBackgroundAdapter(Context context2, BackgroundChangeListener backgroundChangeListener2) {
    ...
    public TART_PuzzleBackgroundAdapter(Context context2, BackgroundChangeListener backgroundChangeListener2, boolean z) {
        this.context = context2;
        this.backgroundChangeListener = backgroundChangeListener2;
    ...
    public TART_PuzzleBackgroundAdapter(Context context2, BackgroundChangeListener backgroundChangeListener2, List<Drawable> list) {
        this.context = context2;
        this.backgroundChangeListener = backgroundChangeListener2;
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            TART_PuzzleBackgroundAdapter.this.selectedSquareIndex = getAdapterPosition();
            TART_PuzzleBackgroundAdapter.this.backgroundChangeListener.onBackgroundSelected((SquareView) TART_PuzzleBackgroundAdapter.this.squareViews.get(TART_PuzzleBackgroundAdapter.this.selectedSquareIndex));
            TART_PuzzleBackgroundAdapter.this.notifyDataSetChanged();
        }
    }
