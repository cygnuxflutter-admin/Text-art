...
class TART_TextureRenderer {
    ...
    public void init() {
        int createProgram = TART_GLToolbox.createProgram(VERTEX_SHADER, FRAGMENT_SHADER);
    ...
    public void renderTexture(int i) {
        ...
        TART_GLToolbox.checkGlError("glUseProgram");
        GLES20.glViewport(0, 0, this.mViewWidth, this.mViewHeight);
        TART_GLToolbox.checkGlError("glViewport");
        ...
        TART_GLToolbox.checkGlError("vertex attribute setup");
        GLES20.glActiveTexture(33984);
        TART_GLToolbox.checkGlError("glActiveTexture");
        GLES20.glBindTexture(3553, i);
        TART_GLToolbox.checkGlError("glBindTexture");
    ...
    private void computeOutputVertices() {
        ...
        if (this.mPosVertices != null) {
            float f2 = (this.mViewWidth / this.mViewHeight) / (this.mTexWidth / this.mTexHeight);
            float f3 = -1.0f;
            float f4 = 1.0f;
            if (f2 > 1.0f) {
                f4 = 1.0f / f2;
