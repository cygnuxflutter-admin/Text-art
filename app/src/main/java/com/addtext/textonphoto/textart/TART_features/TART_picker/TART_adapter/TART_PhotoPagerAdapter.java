...
public class TART_PhotoPagerAdapter extends PagerAdapter {
    ...
    public TART_PhotoPagerAdapter(RequestManager requestManager, List<String> list) {
        this.paths = list;
    ...
    public Object instantiateItem(ViewGroup viewGroup, int i) {
        ...
        View inflate = LayoutInflater.from(context).inflate(R.layout.knack___picker_picker_item_pager, viewGroup, false);
        ...
        if (TART_AndroidLifecycleUtils.canLoadImage(context)) {
