...
public class ImagePickerActivity extends AppCompatActivity implements OnClickListener, OnAlbum, OnListAlbum {
    ...
    public static int limitImageMax = 1;
    int limitImageMin = 1;
...
//        ImagePickerBanner = findViewById(R.id.iv_game);
//        Glide.with(ImagePickerActivity.this)
//                .load(preferenceClass.getDataType("ImagePickerBanner"))
//                .placeholder(R.drawable.game_image_picker)
//                .into(ImagePickerBanner);

//        String url = preferenceClass.getDataType("URL_ImagePickerBanner");

//        ImagePickerBanner.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                CustomTabsIntent.Builder customIntent = new CustomTabsIntent.Builder();
//                customIntent.setToolbarColor(ContextCompat.getColor(ImagePickerActivity.this, R.color.custome_chrom_color));
//                CustomTabChrom.openCustomTab(ImagePickerActivity.this, customIntent.build(), Uri.parse(url));
//            }
//        });
...
//        this.horizontalScrollView.getLayoutParams().height = this.pWHItemSelected;
    ...
    private class GetItemAlbum extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            Uri allImagesuri = Media.EXTERNAL_CONTENT_URI;
            String[] projection = {MediaStore.Images.ImageColumns.DATA, Media.DISPLAY_NAME,
            ...
            try {
                ...
                do {
                    ...
                    String folder = cursor.getString(cursor.getColumnIndexOrThrow(Media.BUCKET_DISPLAY_NAME));
                    String datapath = cursor.getString(cursor.getColumnIndexOrThrow(Media.DATA));
...
*/
    ...
    void addItemSelect(final ImageModel item) {
        ...
        Glide.with(this).load(item.getPathFile()).placeholder(R.drawable.piclist_icon_default).into(imageItem);
...
//        this.txtTotalImage.setText(String.format(getResources().getString(R.string.text_images), new Object[]{Integer.valueOf(this.listItemSelect.size())}));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnDone) {
            ...
            MyApplication.showInterstitialAd(ImagePickerActivity.this, () -> startIntent());
        }
    }
...
//            GallaryImgPath = item.getPathFile();
//            if (GallaryImgPath!=null) {
//                Log.e("TAG", "GallaryImgPath: "+GallaryImgPath);
//                Intent mIntent = new Intent();
//                setResult(Activity.RESULT_OK, mIntent);
//                mIntent.putExtra(KEY_DATA_RESULT, GallaryImgPath);
//
////                done(listString);
//            } else {
//                Toast.makeText(this, "Please select at lease " + this.limitImageMin + " images", Toast.LENGTH_SHORT).show();
//            }
//            Log.e("TAG", "OnItemListAlbumClick: "+item.getPathFile() );
