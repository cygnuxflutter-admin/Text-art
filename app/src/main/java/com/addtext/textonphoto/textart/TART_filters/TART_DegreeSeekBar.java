...
public class TART_DegreeSeekBar extends View {
    ...
    public TART_DegreeSeekBar(Context context) {
        this(context, null);
    }

    public TART_DegreeSeekBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public TART_DegreeSeekBar(Context context, AttributeSet attributeSet, int i) {
