...
class TART_ScaleGestureDetector {
    ...
    private final TART_Vector2D mCurrSpanVector = new TART_Vector2D();
    ...
    public interface OnScaleGestureListener {
        boolean onScale(View view, TART_ScaleGestureDetector scaleGestureDetector);

        boolean onScaleBegin(View view, TART_ScaleGestureDetector scaleGestureDetector);

        void onScaleEnd(View view, TART_ScaleGestureDetector scaleGestureDetector);
    }
    ...
    public TART_ScaleGestureDetector(OnScaleGestureListener onScaleGestureListener) {
    ...
    public TART_Vector2D getCurrentSpanVector() {
