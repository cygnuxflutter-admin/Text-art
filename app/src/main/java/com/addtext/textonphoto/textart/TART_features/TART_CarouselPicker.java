...
public class TART_CarouselPicker extends ViewPager {
    ...
    public TART_CarouselPicker(Context context2) {
        this(context2, (AttributeSet) null);
        this.context = context2;
    }

    public TART_CarouselPicker(Context context2, AttributeSet attributeSet) {
    ...
    public static class CarouselViewAdapter extends PagerAdapter {
        ...
        public CarouselViewAdapter(Context context2, List<PickerItem> list, int i) {
            ...
            this.items = list;
            if (this.drawable == 0) {
                this.drawable = R.layout.knack_carousel_picker;
            }
        }
