...
public class TART_BrushDrawingView extends View {
    private static final float TOUCH_TOLERANCE = 4.0f;
    private Paint bitmapPaint;
    private int brushBitmapSize;
    private List<Point> currentBitmapPoint;
    private TART_DrawBitmapModel currentMagicBrush;
    ...
    private TART_BrushViewChangeListener mBrushViewChangeListener;
    ...
    public TART_BrushDrawingView(Context context) {
        this(context, (AttributeSet) null);
    }

    public TART_BrushDrawingView(Context context, AttributeSet attributeSet) {
        ...
        this.brushBitmapSize = TART_SystemUtil.dpToPx(getContext(), 25);
        this.distance = TART_SystemUtil.dpToPx(getContext(), 3);
        this.currentBitmapPoint = new ArrayList();
        this.tempRect = new Rect();
        setupBrushDrawing();
    }

    public TART_BrushDrawingView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void setCurrentMagicBrush(TART_DrawBitmapModel drawBitmapModel) {
    ...
    public void setDrawMode(int i) {
        ...
        if (this.drawMode == 2) {
            ...
            this.mDrawPaintBlur.setColor(Color.parseColor(TART_ColorUtils.lstColorForBrush().get(0)));
            refreshBrushDrawing();
            return;
        }
        this.mDrawPaint.setColor(Color.parseColor(TART_ColorUtils.lstColorForBrush().get(0)));
        refreshBrushDrawing();
    }
    ...
    public void setBrushSize(float f) {
        if (this.drawMode == 3) {
            this.brushBitmapSize = TART_SystemUtil.dpToPx(getContext(), (int) f);
            return;
        }
        this.mBrushSize = f;
        setBrushDrawingMode(true);
    ...
    public void clearAll() {
        ...
        for (TART_DrawBitmapModel next : TART_MagicBrushAdapter.drawBitmapModels) {
    ...
    public void setBrushViewChangeListener(TART_BrushViewChangeListener brushViewChangeListener) {
