...
public class TART_AddTextProperties {
    ...
    static TART_AddTextProperties getDefaultProperties() {
        TART_AddTextProperties addTextProperties = new TART_AddTextProperties();
