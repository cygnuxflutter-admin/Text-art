...
public class TART_RecyclerTabLayout extends RecyclerView {
    ...
    public TART_RecyclerTabLayout(Context context) {
        this(context, null);
    }

    public TART_RecyclerTabLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public TART_RecyclerTabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mLinearLayoutManager = new LinearLayoutManager(getContext()) {
            public boolean canScrollHorizontally() {
                return TART_RecyclerTabLayout.this.mScrollEanbled;
            }
        };
    ...
    public void startAnimation(final int i) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                TART_RecyclerTabLayout.this.scrollToTab(i, ((Float) valueAnimator.getAnimatedValue()).floatValue(), true);
            }
        });
        valueAnimator.start();
    }
    ...
    protected static class RecyclerOnScrollListener extends RecyclerView.OnScrollListener {
        public int mDx;
        protected LinearLayoutManager mLinearLayoutManager;
        protected TART_RecyclerTabLayout mRecyclerTabLayout;

        public RecyclerOnScrollListener(TART_RecyclerTabLayout recyclerTabLayout, LinearLayoutManager linearLayoutManager) {
    ...
    protected static class ViewPagerOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final TART_RecyclerTabLayout mRecyclerTabLayout;
        private int mScrollState;

        public ViewPagerOnPageChangeListener(TART_RecyclerTabLayout recyclerTabLayout) {
            this.mRecyclerTabLayout = recyclerTabLayout;
        }
