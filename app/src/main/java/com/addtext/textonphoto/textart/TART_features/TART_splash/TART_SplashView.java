...
public class TART_SplashView extends AppCompatImageView {
    ...
    public TART_SplashView(Context context) {
        super(context);
        init();
    }

    public TART_SplashView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public TART_SplashView(Context context, AttributeSet attributeSet, int i) {
    ...
    private void init() {
        ...
        this.paintCircle.setColor(ContextCompat.getColor(getContext(),R.color.colorAccent));
        this.paintCircle.setStrokeWidth((float) TART_SystemUtil.dpToPx(getContext(), 2));
    ...
    public void addSticker(@NonNull final Sticker sticker2, final int i) {
        if (ViewCompat.isLaidOut(this)) {
            ...
            post(new Runnable() {
                public void run() {
                    TART_SplashView.this.addStickerImmediately(sticker2, i);
                }
            });
        }
    }
    ...
    public void onTouchUp(@NonNull MotionEvent motionEvent) {
        ...
        if (this.currentSplashMode == 0) {
            ...
            TART_BrushDrawingView.LinePath linePath = new TART_BrushDrawingView.LinePath(this.mPath, this.mDrawPaint);
