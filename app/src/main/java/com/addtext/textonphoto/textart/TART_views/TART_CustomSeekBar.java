...
public class TART_CustomSeekBar extends AppCompatSeekBar {
    private Paint paint;
    private Rect rect;
    private int seekbar_height;

    public TART_CustomSeekBar(Context context) {
        super(context);
    }

    public TART_CustomSeekBar(Context context, AttributeSet attributeSet) {
    ...
    public TART_CustomSeekBar(Context context, AttributeSet attributeSet, int i) {
