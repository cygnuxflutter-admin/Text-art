...
class TART_SlantUtils {
    ...
    static List<TART_SlantArea> cutAreaWith(TART_SlantArea slantArea, TART_SlantLine slantLine) {
        ArrayList arrayList = new ArrayList();
        TART_SlantArea slantArea2 = new TART_SlantArea(slantArea);
        TART_SlantArea slantArea3 = new TART_SlantArea(slantArea);
        if (slantLine.direction == TART_Line.Direction.HORIZONTAL) {
    ...
    static TART_SlantLine createLine(TART_SlantArea slantArea, TART_Line.Direction direction, float f, float f2) {
        TART_SlantLine slantLine = new TART_SlantLine(direction);
        slantLine.setEndRatio(f2);
        slantLine.setStartRatio(f);
        if (direction == TART_Line.Direction.HORIZONTAL) {
            slantLine.start = getPoint(slantArea.leftTop, slantArea.leftBottom, TART_Line.Direction.VERTICAL, f);
            slantLine.end = getPoint(slantArea.rightTop, slantArea.rightBottom, TART_Line.Direction.VERTICAL, f2);
            ...
            slantLine.start = getPoint(slantArea.leftTop, slantArea.rightTop, TART_Line.Direction.HORIZONTAL, f);
            slantLine.end = getPoint(slantArea.leftBottom, slantArea.rightBottom, TART_Line.Direction.HORIZONTAL, f2);
    ...
    static Pair<List<TART_SlantLine>, List<TART_SlantArea>> cutAreaWith(TART_SlantArea slantArea, int i, int i2) {
        int i3;
        ArrayList arrayList = new ArrayList();
        ...
        for (int i4 = i + 1; i4 > 1; i4--) {
            ...
            TART_SlantLine createLine = createLine(slantArea2, TART_Line.Direction.HORIZONTAL, f - 0.025f, f + 0.025f);
        ...
        while (true) {
            ...
            TART_SlantLine createLine2 = createLine(slantArea3, TART_Line.Direction.VERTICAL, f2 + 0.025f, f2 - 0.025f);
            arrayList3.add(createLine2);
            TART_SlantArea slantArea4 = new TART_SlantArea(slantArea3);
            slantArea4.lineLeft = createLine2;
            slantArea4.leftTop = createLine2.start;
            slantArea4.leftBottom = createLine2.end;
            while (i3 <= arrayList2.size()) {
                TART_SlantArea slantArea5 = new TART_SlantArea(slantArea4);
                if (i3 == 0) {
                    slantArea5.lineTop = (TART_SlantLine) arrayList2.get(i3);
                } else if (i3 == arrayList2.size()) {
                    slantArea5.lineBottom = (TART_SlantLine) arrayList2.get(i3 - 1);
                    TART_CrossoverPointF crossoverPointF = new TART_CrossoverPointF(slantArea5.lineBottom, slantArea5.lineLeft);
                    intersectionOfLines(crossoverPointF, slantArea5.lineBottom, slantArea5.lineLeft);
                    TART_CrossoverPointF crossoverPointF2 = new TART_CrossoverPointF(slantArea5.lineBottom, slantArea5.lineRight);
                ...
                TART_CrossoverPointF crossoverPointF3 = new TART_CrossoverPointF(slantArea5.lineTop, slantArea5.lineLeft);
                intersectionOfLines(crossoverPointF3, slantArea5.lineTop, slantArea5.lineLeft);
                TART_CrossoverPointF crossoverPointF4 = new TART_CrossoverPointF(slantArea5.lineTop, slantArea5.lineRight);
        ...
        while (i3 <= arrayList2.size()) {
            TART_SlantArea slantArea6 = new TART_SlantArea(slantArea3);
            if (i3 == 0) {
                slantArea6.lineTop = (TART_SlantLine) arrayList2.get(i3);
            } else if (i3 == arrayList2.size()) {
                slantArea6.lineBottom = (TART_SlantLine) arrayList2.get(i3 - 1);
                TART_CrossoverPointF crossoverPointF5 = new TART_CrossoverPointF(slantArea6.lineBottom, slantArea6.lineLeft);
                intersectionOfLines(crossoverPointF5, slantArea6.lineBottom, slantArea6.lineLeft);
                TART_CrossoverPointF crossoverPointF6 = new TART_CrossoverPointF(slantArea6.lineBottom, slantArea6.lineRight);
            ...
            TART_CrossoverPointF crossoverPointF7 = new TART_CrossoverPointF(slantArea6.lineTop, slantArea6.lineLeft);
            intersectionOfLines(crossoverPointF7, slantArea6.lineTop, slantArea6.lineLeft);
            TART_CrossoverPointF crossoverPointF8 = new TART_CrossoverPointF(slantArea6.lineTop, slantArea6.lineRight);
    ...
    static List<TART_SlantArea> cutAreaCross(TART_SlantArea slantArea, TART_SlantLine slantLine, TART_SlantLine slantLine2) {
        ArrayList arrayList = new ArrayList();
        TART_CrossoverPointF crossoverPointF = new TART_CrossoverPointF(slantLine, slantLine2);
        ...
        arrayList.add(slantArea3);
        TART_SlantArea slantArea4 = new TART_SlantArea(slantArea);
        ...
        TART_SlantArea slantArea5 = new TART_SlantArea(slantArea);
    ...
    private static TART_CrossoverPointF getPoint(PointF pointF, PointF pointF2, TART_Line.Direction direction, float f) {
        TART_CrossoverPointF crossoverPointF = new TART_CrossoverPointF();
        getPoint(crossoverPointF, pointF, pointF2, direction, f);
        return crossoverPointF;
    }

    static void getPoint(PointF pointF, PointF pointF2, PointF pointF3, TART_Line.Direction direction, float f) {
    ...
    static boolean contains(TART_SlantArea slantArea, float f, float f2) {
    ...
    static boolean contains(TART_SlantLine slantLine, float f, float f2, float f3) {
        TART_CrossoverPointF crossoverPointF = slantLine.start;
        TART_CrossoverPointF crossoverPointF2 = slantLine.end;
        if (slantLine.direction == TART_Line.Direction.VERTICAL) {
    ...
    static void intersectionOfLines(TART_CrossoverPointF crossoverPointF, TART_SlantLine slantLine, TART_SlantLine slantLine2) {
    ...
    private static boolean isHorizontalLine(TART_SlantLine slantLine) {
        return slantLine.start.y == slantLine.end.y;
    }

    private static boolean isVerticalLine(TART_SlantLine slantLine) {
        return slantLine.start.x == slantLine.end.x;
    }

    private static boolean isParallel(TART_SlantLine slantLine, TART_SlantLine slantLine2) {
        return calculateSlope(slantLine) == calculateSlope(slantLine2);
    }

    static float calculateSlope(TART_SlantLine slantLine) {
    ...
    private static float calculateVerticalIntercept(TART_SlantLine slantLine) {
        if (isHorizontalLine(slantLine)) {
