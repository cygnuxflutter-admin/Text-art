...
public interface TART_PuzzleLayout {
    TART_PuzzleLayout clone(TART_PuzzleLayout puzzleLayout);

    Info generateInfo();

    TART_Area getArea(int i);
    ...
    TART_Area getOuterArea();

    List<TART_Line> getOuterLines();
    ...
    class Info implements Parcelable {
        ...
        public ArrayList<TART_Line> lines;
    ...
    class Step implements Parcelable {
        ...
        public TART_Line.Direction lineDirection() {
            return this.direction == 0 ? TART_Line.Direction.HORIZONTAL : TART_Line.Direction.VERTICAL;
        }
    ...
    class LineInfo implements Parcelable {
        ...
        public LineInfo(TART_Line line) {
