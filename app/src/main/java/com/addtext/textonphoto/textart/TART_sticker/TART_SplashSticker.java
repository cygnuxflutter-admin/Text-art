...
public class TART_SplashSticker extends Sticker {
    private Bitmap bitmapOver;
    private Bitmap bitmapXor;
    private Paint over;
    private Paint xor = new Paint();

    public TART_SplashSticker(Bitmap paramBitmap1, Bitmap paramBitmap2) {
    ...
    @NonNull
    public TART_SplashSticker setAlpha(@IntRange(from = 0L, to = 255L) int paramInt) {
        return this;
    }

    public TART_SplashSticker setDrawable(@NonNull Drawable paramDrawable) {
        return this;
    }
}
