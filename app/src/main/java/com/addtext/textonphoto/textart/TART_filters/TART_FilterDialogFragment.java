...
public class TART_FilterDialogFragment extends DialogFragment implements TART_FilterListener {
    ...
    public static TART_FilterDialogFragment show(@NonNull AppCompatActivity appCompatActivity, OnFilterSavePhoto onFilterSavePhoto2, Bitmap bitmap2, List<Bitmap> list) {
        TART_FilterDialogFragment filterDialogFragment = new TART_FilterDialogFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        View inflate = layoutInflater.inflate(R.layout.knack_filter_layout, viewGroup, false);
        this.rvFilterView = inflate.findViewById(R.id.rvFilterView);
        this.rvFilterView.setAdapter(new TART_FilterViewAdapter(this.lstFilterBitmap, this, getActivity(), Arrays.asList(TART_FilterUtils.EFFECT_CONFIGS)));
        ...
        (inflate.findViewById(R.id.imgSave)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                TART_FilterDialogFragment.this.onFilterSavePhoto.onSaveFilter(((BitmapDrawable) TART_FilterDialogFragment.this.preview.getDrawable()).getBitmap());
                TART_FilterDialogFragment.this.dismiss();
            }
        });
    ...
    class LoadBitmapWithFilter extends AsyncTask<String, Bitmap, Bitmap> {
        ...
        public void onPreExecute() {
            TART_FilterDialogFragment.this.showLoading(true);
        }


        public Bitmap doInBackground(String... strArr) {
            return TART_FilterUtils.getBitmapWithFilter(TART_FilterDialogFragment.this.bitmap, strArr[0]);
        }


        public void onPostExecute(Bitmap bitmap) {
            TART_FilterDialogFragment.this.preview.setImageBitmap(bitmap);
            TART_FilterDialogFragment.this.showLoading(false);
        }
    }
