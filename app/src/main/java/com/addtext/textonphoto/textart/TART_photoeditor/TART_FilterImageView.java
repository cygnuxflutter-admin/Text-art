...
public class TART_FilterImageView extends AppCompatImageView {
    ...
    public TART_FilterImageView(Context context) {
        super(context);
    }

    public TART_FilterImageView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public TART_FilterImageView(Context context, AttributeSet attributeSet, int i) {
