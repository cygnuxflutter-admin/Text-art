...
public class TART_BeautySticker extends Sticker {
    ...
    public TART_BeautySticker(Context paramContext, int paramInt, Drawable paramDrawable) {
        this.drawableSizeBoobs = TART_SystemUtil.dpToPx(paramContext, 50);
        this.drawableSizeHip1_Width = TART_SystemUtil.dpToPx(paramContext, 150);
        this.drawableSizeHip1_Height = TART_SystemUtil.dpToPx(paramContext, 75);
        this.drawableSizeFace_Height = TART_SystemUtil.dpToPx(paramContext, 50);
        this.drawableSizeFace_Width = TART_SystemUtil.dpToPx(paramContext, 80);
        this.type = paramInt;
    ...
    @NonNull
    public TART_BeautySticker setAlpha(@IntRange(from = 0L, to = 255L) int paramInt) {
        this.drawable.setAlpha(paramInt);
        return this;
    }

    public TART_BeautySticker setDrawable(@NonNull Drawable paramDrawable) {
        return this;
    }
