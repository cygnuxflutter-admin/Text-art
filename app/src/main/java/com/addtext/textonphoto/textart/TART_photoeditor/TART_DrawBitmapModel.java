...
public class TART_DrawBitmapModel {
    ...
    private List<TART_BrushDrawingView.Vector2> mPositions = new ArrayList(100);
    private int mainIcon;

    private int to;

    public TART_DrawBitmapModel(int i, List<Integer> list, boolean z, Context context2) {
        this.mainIcon = i;
    ...
    public List<TART_BrushDrawingView.Vector2> getmPositions() {
