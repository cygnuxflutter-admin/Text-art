...
public class TART_MatrixUtils {
    ...
    public static float getMinMatrixScale(TART_PuzzlePiece puzzlePiece) {
        if (puzzlePiece == null) {
            return 1.0f;
        }
        sTempMatrix.reset();
    ...
    static boolean judgeIsImageContainsBorder(TART_PuzzlePiece puzzlePiece, float f) {
        sTempMatrix.reset();
    ...
    static float[] calculateImageIndents(TART_PuzzlePiece puzzlePiece) {
        if (puzzlePiece == null) {
    ...
    public static Matrix generateMatrix(TART_PuzzlePiece puzzlePiece, float f) {
        return generateMatrix(puzzlePiece.getArea(), puzzlePiece.getDrawable(), f);
    }

    public static Matrix generateMatrix(TART_Area area, Drawable drawable, float f) {
        return generateCenterCropMatrix(area, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight(), f);
    }

    private static Matrix generateCenterCropMatrix(TART_Area area, int i, int i2, float f) {
        float f2;
