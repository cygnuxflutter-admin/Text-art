...
public class TART_AlbumAdapter extends ArrayAdapter<TART_ImageModel> {
    Context context;
    ...
    public TART_AlbumAdapter(Context context2, int i, ArrayList<TART_ImageModel> arrayList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        TART_ImageModel imageModel = this.data.get(i);
        recordHolder.txtTitle.setText(imageModel.getName());
        recordHolder.txtPath.setText(imageModel.getPathFolder());
        ((RequestBuilder) Glide.with(this.context).load(new File(imageModel.getPathFile())).placeholder((int) R.drawable.knack_piclist_icon_default)).into(recordHolder.imageItem);
        view.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (TART_AlbumAdapter.this.onItem != null) {
                    TART_AlbumAdapter.this.onItem.OnItemAlbumClick(i);
                }
            }
        });
        return view;
    ...
    public void setOnItem(TART_OnAlbum onAlbum) {
        this.onItem = onAlbum;
    }
