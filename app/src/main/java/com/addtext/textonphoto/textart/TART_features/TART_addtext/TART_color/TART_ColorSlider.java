package com.addtext.textonphoto.textart.TART_features.TART_addtext.TART_color;
...
public class TART_ColorSlider extends View {
    ...
    public TART_ColorSlider(Context context) {
        super(context);
        init(context, null);
    }

    public TART_ColorSlider(Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
        init(context, attributeSet);
    }

    public TART_ColorSlider(Context context, @Nullable AttributeSet attributeSet, int i) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View view, MotionEvent motionEvent) {
                return TART_ColorSlider.this.processTouch(motionEvent);
            }
        });
