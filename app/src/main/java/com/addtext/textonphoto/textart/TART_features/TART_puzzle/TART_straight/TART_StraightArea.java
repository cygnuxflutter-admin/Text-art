...
class TART_StraightArea implements TART_Area {
    private Path areaPath;
    private RectF areaRect;
    private PointF[] handleBarPoints;
    TART_StraightLine lineBottom;
    TART_StraightLine lineLeft;
    TART_StraightLine lineRight;
    TART_StraightLine lineTop;
    ...
    TART_StraightArea(TART_StraightArea straightArea) {
        this.areaPath = new Path();
        this.areaRect = new RectF();
        this.handleBarPoints = new PointF[2];
    ...
    static class AreaComparator implements Comparator<TART_StraightArea> {
        AreaComparator() {
        }

        public int compare(TART_StraightArea straightArea, TART_StraightArea straightArea2) {
